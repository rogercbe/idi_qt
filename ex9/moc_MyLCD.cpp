...
static const char qt_meta_stringdata_MyLCD[] = {
    "MyLCD\0\0reiniciar()\0setNumero(int)\0"
    "opSumar()\0opRestar()\0desfer()\0"
};
...
void MyLCD::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setNumero((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->opSumar(); break;
        case 3: _t->opRestar(); break;
        case 4: _t->desfer(); break;
        default: ;
        }
    }
}
